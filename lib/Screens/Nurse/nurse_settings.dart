...
class NurseSettings extends StatefulWidget {
  final int id;
  const NurseSettings({super.key, required this.id});

  @override
  State<NurseSettings> createState() => _SettingsPageState();
}

class _SettingsPageState extends State<NurseSettings>
  ...
  Future<void> _handleDeleteAccount(BuildContext context) async {
    ...
    try {
      ...
      await patientProvider.deleteNurse(id: widget.id);
