              ...
              builder: (context, value, child) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return NurseCard(index: index, nurse: nurses.Model[index]);
                  },
                );
              },
            ),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text("Phone: ${nurse["contact"]}", style: TextStyle(color: Colors.black)),
                          Text("Message: ${nurse["message"]}", style: TextStyle(color: Colors.black)),
                        ],
                      ),
                    ),
                    Container(
                ...
                ElevatedButton(
                  ...
                  onPressed: () async {
                    final result = await Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => NurseDetails(nurse: adminProv.nurseModel!.Model[index]),
                      ),
                    );
