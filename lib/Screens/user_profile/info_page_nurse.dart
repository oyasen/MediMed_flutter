...
import 'package:medimed/Screens/user_profile/update_nurse_profile.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              if(patient.Model["approved"] == "Declined") ElevatedButton(
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => UpdateNurseProfile(patient: patient),));
                },
