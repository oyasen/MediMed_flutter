    ...
    return Scaffold(
      ...
      body: Consumer<PatientProvider>(
        builder: (context, patientProvider, child) {
          if (patientProvider.patientsModel == null) {
            return const Center(child: CircularProgressIndicator());
          }

          if (patientProvider.patientsModel!.Model.isEmpty) {
          ...
          return Padding(
            ...
            child: ListView.builder(
              itemCount: patientProvider.patientsModel!.Model.length,
              itemBuilder: (context, index) {
                final nurse = patientProvider.patientsModel!.Model[index];
                ...
                return GestureDetector(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => BookingPage(), // Replace with actual page
                      ),
                    );
                  ...
                  child: Container(
                    ...
                    child: ListTile(
                      ...
                      title: Text(
                        nurse['nurse']['fullName'] ?? 'Unknown', // Nurse name from API
